...
/**
 * Quick-fact icon set for destination pages. Line-art style matching the brand
 * (24×24, stroke currentColor). The admin destination editor mirrors this exact
 * set (admin/client/src/components/destinations/QuickFactIcon.tsx) so an icon
 * picked in the CMS renders identically on the public page. Keep the two in sync.
 */
...
/** Ordered options for the CMS icon picker (id → human label). */
