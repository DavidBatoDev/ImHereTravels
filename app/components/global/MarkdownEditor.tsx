...
/**
 * Live WYSIWYG review composer: a contentEditable surface that shows bold,
 * italic, and list formatting as the traveler types (Slack/ClickUp-style),
 * with no separate write/preview toggle. Formatting is applied via
 * document.execCommand and the DOM is serialized to a Markdown string on
 * every change, so the stored/submitted value and the final <Markdown/>
 * render stay in sync with what the editor shows.
 */
...
export default function MarkdownEditor({
  ...
  // the traveler's text selection — capture it up front (the toolbar
  // button's onMouseDown already prevented that focus loss up to this
  // click) so we can restore it once they confirm a URL.
