...
export const REVIEW_THEMES: ReviewTheme[] = [
  { key: "guides", label: "Great guides", pattern: /\b(guides?|tour leaders?|leaders?|staff|hosts?|knowledgeable)\b/i },
  { key: "scenery", label: "Stunning scenery", pattern: /\b(scenery|scenic|views?|beautiful|stunning|landscapes?|breathtaking|gorgeous|paradise)\b/i },
  { key: "organized", label: "Well organized", pattern: /\b(organi[sz]\w*|seamless|smooth|well[- ]planned|coordination|itinerar\w*|planned)\b/i },
  { key: "value", label: "Value for money", pattern: /\b(value|worth|affordable|budget|reasonable|pricing|price|money)\b/i },
  { key: "adventure", label: "Adventure & activities", pattern: /\b(adventur\w*|activit\w*|hik\w*|snorkel\w*|island hopping|kayak\w*|packed|excursions?)\b/i },
  { key: "group", label: "Fun group", pattern: /\b(group|friends|friendly|social|bonding|welcoming)\b/i },
  { key: "stays", label: "Comfortable stays", pattern: /\b(accommodations?|hotels?|rooms?|resorts?|comfortable|cozy|clean)\b/i },
  { key: "food", label: "Great food", pattern: /\b(food|meals?|cuisine|delicious|dishes)\b/i },
  ...
  { key: "culture", label: "Local culture", pattern: /\b(cultur\w*|locals?|temples?|history|historical|authentic|tradition\w*)\b/i },
  { key: "unforgettable", label: "Unforgettable", pattern: /\b(unforgettable|memorable|once in a lifetime|life[- ]changing|highlight)\b/i },
];
