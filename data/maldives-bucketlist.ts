...
export const maldivesBucketlist: Tour = {
  ...
  "meta": {
    ...
    "description": "Experience the Maldives Island Adventure! Explore bustling Male City, dive into coral reefs in Rasdhoo, and unwind on an uninhabited island paradise. From thrilling underwater adventures to sunset pad"
  },
  "gallery": {
  ...
  "header": {
    ...
    "description": "Experience the Maldives Island Adventure! Explore bustling Male City, dive into coral reefs in Rasdhoo, and unwind on an uninhabited island paradise. From thrilling underwater adventures to sunset paddling and dolphin cruises, this trip is packed with unforgettable moments!"
  },
  "keyFacts": [
    {
      "icon": "days",
  ...
  "listingCard": {
    ...
    "description": "Experience the Maldives Island Adventure! Explore bustling Male City, dive into coral reefs in Rasdhoo, and unwind on an uninhabited island paradise. From thril",
    "price": "GBP £1,400",
