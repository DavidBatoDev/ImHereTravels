...
export const philippineSunset: Tour = {
  ...
  "meta": {
    "title": "Philippine Sunset — I'm Here Travels",
  ...
  "gallery": {
    ...
    "heroAlt": "Philippine Sunset",
    "thumbnails": []
  },
  "header": {
    "title": "11 days | Philippine Sunset",
    "tags": [
      {
        "label": "Philippines",
        "icon": "location"
  ...
  "itinerary": {
    ...
    "downloadHref": "https://drive.google.com/file/d/1g6aQrfOdP14T3HfD5D9AmIzKaLz5sJ9Q/view?usp=drive_link",
    "days": [
      {
        "dayNumber": 1,
